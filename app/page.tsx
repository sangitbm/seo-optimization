      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section className="py-16">
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-muted-foreground">
              Our most-used SEO tools — trusted by developers and marketers
            </p>
          </div>
        ...
        <section id="tools" className="scroll-mt-20 py-16">
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-muted-foreground">
              Browse our complete collection of free SEO tools
            </p>
          </div>
          <ToolSearch />
        </section>
        ...
        <section className="py-16">
          <div className="mb-8">
            ...
            <p className="mt-2 text-lg text-muted-foreground">
              Check out our latest tools and features
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "All tools run in your browser with zero server round-trips. Get instant results without waiting.",
              },
              {
                icon: Shield,
                title: "100% Private",
                description: "Your data never leaves your browser. No tracking, no storage, no server-side processing.",
              },
              {
                icon: Globe,
                title: "SEO Optimized",
                description: "Every tool follows SEO best practices and generates standards-compliant output ready for production.",
              },
            ].map((feature) => (
              <div
                key={feature.title}
