  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-violet dark:prose-invert max-w-none space-y-6 text-muted-foreground">
        <p>
          At SEO Utilities (accessible from seo-utilities.com), one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by SEO Utilities and how we use it.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Local Processing & Client-Side Tools</h2>
        <p>
          <strong>We do not collect or store your inputs.</strong> Almost all of the tools provided on SEO Utilities run entirely client-side (within your browser). The URLs, text, and settings you enter into our tools are processed locally and are never transmitted to our servers or stored in any database.
        </p>

        <h2 className="text-2xl font-bold text-foreground mt-8 mb-4">Log Files</h2>
        <p>
          SEO Utilities follows a standard procedure of using log files. These files log visitors when they visit websites. The information collected by log files includes internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable.
        </p>
